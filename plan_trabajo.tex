...
\begin{itemize}
    ...
    \item \textbf{Josue (Integrante C)} — Frontend UI/UX + Supervisor General (toolbar, paneles, calculadora, gráficas, tema claro, revisión de calidad)
\end{itemize}
...
\textbullet~Verificar tema claro global\\&
...
\textbullet~Probar calculadora en tema claro\\&
...
\begin{enumerate}[label=\textbf{C\arabic*}]
    \item \textbf{Tema claro} — Interfaz crema/verde consistente en toda la aplicación.
    ...
    \item \textbf{Calculadora} — 7 tabs funcionales con el tema claro de la app.

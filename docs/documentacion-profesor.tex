...
\begin{table}[H]
  ...
  \begin{tabular}{lll}
    ...
    \midrule
    Miguel Angel Alvarez Ramirez & \texttt{feature/miguel-editor} & Editor React Flow, store, cables \\
    Luisa Fernanda Ibarra Tucano & \texttt{feature/luisa-backend} & Motor MNA, backend, validación \\
    David Josué Solorza Viera & \texttt{feature/josue-ui} & UI/UX, paneles, documentación, despliegue \\
    \bottomrule
  \end{tabular}

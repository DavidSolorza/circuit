...
- **Workflows**: Repeatable processes (new feature, bug fix, UI improvement, etc.)
- **Prompts**: Ready-to-use prompts for common tasks
- **Memory**: Project context, decisions, goals, architecture
...
4. Backend creates APIs
5. Frontend creates interfaces
6. UIUX polishes experience
7. Reviewer validates quality
8. Testing ensures reliability
9. DevOps handles deployment
10. Documentation records everything
